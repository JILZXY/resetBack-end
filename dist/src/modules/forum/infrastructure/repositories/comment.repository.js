...
let CommentRepository = class CommentRepository {
    ...
    async create(data) {
        const comment = await this.commentModel.create({
            postId: new mongoose_2.Types.ObjectId(data.postId),
    ...
    async findByPostId(postId) {
        const comments = await this.commentModel
            .find({ postId: new mongoose_2.Types.ObjectId(postId), isDeleted: false })
            .sort({ createdAt: 1 })
            .exec();
    ...
    async softDeleteByPostId(postId) {
        await this.commentModel
            .updateMany({ postId: new mongoose_2.Types.ObjectId(postId) }, { $set: { isDeleted: true } })
            .exec();
    }
