...
let RejectSponsorshipUseCase = class RejectSponsorshipUseCase {
    ...
    async execute(userId) {
        ...
        if (!pending) {
            throw new common_1.HttpException({ code: 'NO_PENDING_REQUEST', message: 'No tienes solicitudes de apadrinamiento pendientes', details: {} }, common_1.HttpStatus.NOT_FOUND);
        }
